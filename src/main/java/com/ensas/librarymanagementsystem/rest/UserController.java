...
import com.ensas.librarymanagementsystem.configuration.LoggedUser;
...
//    }
    ...
    public int getActiveUserCount() {
        return activeUserStore.getUsers().size();
    }
    ...
    public ResponseEntity<LoggedUser> getUserDetails(@PathVariable String username) {
        List<String> users = activeUserStore.getUsers();
        if (users.contains(username)) {
            return ResponseEntity.ok(new LoggedUser(username, activeUserStore));
        } else {
